# ═══════════════════════════════════════════════════════════════════════
# WIZARD KEPLER — GEMINI CLI VERSION
# ═══════════════════════════════════════════════════════════════════════
# HOW TO USE THIS FILE ON GEMINI CLI:
#   Drop this file into your working directory as GEMINI.md.
#   Gemini CLI picks it up automatically when you start a session
#   in that directory.
# ═══════════════════════════════════════════════════════════════════════
