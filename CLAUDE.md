# ═══════════════════════════════════════════════════════════════════════
# WIZARD KEPLER — CLAUDE CODE / CLAUDE.AI VERSION
# ═══════════════════════════════════════════════════════════════════════
# HOW TO USE THIS FILE ON CLAUDE:
#   Claude Code:  Drop this file into your project directory as CLAUDE.md
#   Claude.ai:    Copy the full contents → New Project → Project Instructions → Paste → Save
#   Cowork:       Same as Claude.ai above
# ═══════════════════════════════════════════════════════════════════════
