# ═══════════════════════════════════════════════════════════════════════
# WIZARD KEPLER — CODEX CLI / HERMES-MINIMAX-OLLAMA VERSION
# ═══════════════════════════════════════════════════════════════════════
# HOW TO USE THIS FILE:
#   Codex CLI:    Drop this file into your working directory as AGENTS.md
#                 The CLI picks it up automatically on next run.
#   Hermes:       Drop this file into your working directory as AGENTS.md
#                 Or place it in your .hermes/ directory.
# ═══════════════════════════════════════════════════════════════════════
